...
import { findProductFromParam } from '../middlewares/findProduct';

const productRouter = Router();

productRouter.get('/', CacheStorage.checkCache, 
...
productRouter.route('/:product_id/reviews')
    ...
    .post(validate, authenticate.verifyUser, findProductFromParam,
        ProductController.addProductsReviews());
