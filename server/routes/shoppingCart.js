...
import findAttributes from '../middlewares/findAttributes';

const shoppingCartRouter = Router();

shoppingCartRouter.get('/generateUniqueId', ShoppingCartController.generateUniqueId());

shoppingCartRouter.post('/add', validate, findProduct, 
findAttributes, ShoppingCartController.addProductToCart());
